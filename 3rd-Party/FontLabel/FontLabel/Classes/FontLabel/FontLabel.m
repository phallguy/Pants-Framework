...
-(void) renderText: (CGRect) rect color: (UIColor *) color
{
    [color setFill];
...
- (void)drawTextInRect:(CGRect)rect {
	...
	if (self.zAttributedText == nil) {
        ...
        if( self.shadowColor )
        {
            CGRect shadowRect = CGRectOffset( rect, self.shadowOffset.width, self.shadowOffset.height );
            [self renderText: shadowRect color: self.shadowColor];
        }
    
        
        UIColor * clr ;
        if (self.highlighted) {
            clr = (self.highlightedTextColor ?: [UIColor whiteColor]);
        } else {
            clr = (self.textColor ?: [UIColor blackColor]);
        }
        
        [self renderText: rect color: clr];
